   ...
   public class conexion :Page
    {
        ...
        public string login(string usuario, string clave)
        {
            ...
            {
                AbrirConexion();
                sqlComando = new SqlCommand("login", sqlConexion);
                sqlComando.CommandType = CommandType.StoredProcedure;
                sqlComando.Parameters.Add(new SqlParameter("@email", usuario));
                sqlComando.Parameters.Add(new SqlParameter("@clave", clave));
                string elUsuario = sqlComando.ExecuteScalar().ToString();
